...
/**
 * HTML Proveedor View class for the Proveedor component
 *
 * @since  1.5
 */
class ProveedorViewProveedor extends JViewLegacy
{
	...
	/**
	 * The form object for the proveedor item
	 *
	 * @var    JForm
	 * @since  1.6
	 */
		...
		switch ($params->get('proveedor_icons'))
		{
			...
			default :
				...
				else
				{
					$image5 = JHtml::_(
						'image',
						'proveedors/' . $params->get('icon_misc', 'con_info.png'),
						JText::_('COM_PROVEEDOR_OTHER_INFORMATION') . ": ", null, true
					);
				}
