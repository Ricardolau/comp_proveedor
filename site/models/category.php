 ...
 * @since       1.5
 */
class ProveedorModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	...
	public function getItems()
	{
		...
		for ($i = 0, $n = count($items); $i < $n; $i++)
		{
			...
			$this->tags->getItemTags('com_proveedor.proveedor', $item->id);
		}
	...
	public function getCategory()
	{
		if (!is_object($this->_item))
		{
			...
			$categories = JCategories::getInstance('Proveedor', $options);
