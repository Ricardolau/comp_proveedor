...
/**
 * Featured proveedor model class.
 *
 * @since  1.6.0
 */
class ProveedorModelFeatured extends JModelList
{
	/**
	 * Category items data
	 *
	...
	/**
	 * The list of other proveedores categories.
	 *
	 * @access    protected
	 * @var       array
	 * @deprecated   4.0  Variable not used ever
	...
	protected function getListQuery()
	{
		...
		$query->select($this->getState('list.select', 'a.*'))
			->from($db->quoteName('#__proveedor_details') . ' AS a')
		...
		$subquery .= 'WHERE parent.extension = ' . $db->quote('com_proveedor');

		// Find any up-path categories that are not published
		// If all categories are published, badcats.id will be null, and we just use the proveedor state
